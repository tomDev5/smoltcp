...
fn test_icmpv4_socket(#[case] medium: Medium) {
    ...
    let socket_handle = sockets.add(icmpv4_socket).expect("Failed to add socket");
...
fn test_raw_socket_no_reply(#[case] medium: Medium) {
    ...
    sockets.add(raw_socket).expect("Failed to add socket");
...
fn test_raw_socket_with_udp_socket(#[case] medium: Medium) {
    ...
    let udp_socket_handle = sockets.add(udp_socket).expect("Failed to add socket");
